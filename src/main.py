...
from src.data import CIFAR10DataModule, create_data_module
from src.models import SimpleCNN, create_model, create_trainer
...
def train_pipeline(config: DictConfig) -> Dict[str, Any]:
    ...
    with mlflow_manager.start_run():
        ...
        mlflow_manager.log_parameters({
            ...
            "training_weight_decay": config.training.weight_decay,
            "training_momentum": config.training.momentum,
